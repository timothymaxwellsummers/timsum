      ...
      <Card>
        <Flex gap="5" direction={isDesktop ? "row" : "column"} align={isDesktop ? undefined : "center"}>
          ...
          <Flex direction="column" gap="3" justify="center" pr="5">
            <Heading size="6">LMU Students</Heading>
            <Text>During my masters degree @LMU we founded LMU Developers. A non profit student group focused on building digital products for the university community and teaching students about software development.</Text>
            <Flex gap="2">
              <Badge variant="surface" color='amber'>Python</Badge>
              <Badge variant="surface" color='blue'>Flutter</Badge>
              <Badge variant="surface" color='crimson'>Figma</Badge>
            </Flex>
            <Flex gap="2">
              <Badge variant="surface" color='orange'>Postman</Badge>
              <Badge variant="surface" color='iris'>Strapi</Badge>
              <Badge variant="surface" color='blue'>Docker</Badge>
            </Flex>
            <Flex>
              <a href="https://github.com/lmu-devs" target="_blank" style={{ textDecoration: 'none', }}>
                <Button variant="outline" color="purple" size="2"><GitHubLogoIcon width="12" height="12" />LMU Developers is Open Source</Button>
              </a>
            </Flex>
          </Flex>
        </Flex>
