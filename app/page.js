  ...
  return (
    <Container size="2">
      <Flex direction="column" gap="4">
        ...
        <Text>I like to built digital stuff. From websites and apps to 3D stuff. I finished an economics focused cs study program @TUM and am currently enrolled in a media focused cs master @LMU. At the same time I work at MaiborWolff an IT consulting company in Munich. Trying to grow and learn more every day!</Text>
